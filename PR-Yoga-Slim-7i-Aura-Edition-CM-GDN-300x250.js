...
lib.ssMetadata = [
		{name:"PR_Yoga_Slim_7i_Aura_Edition_CM_GDN_300x250_atlas_1", frames: [[604,0,50,50],[0,0,300,250],[0,252,300,250],[0,504,300,250],[0,756,300,250],[302,0,300,250],[302,252,300,250],[302,504,300,250],[302,756,300,250]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_Yoga_Slim_7i_Aura_Edition_CM_GDN_300x250_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRYogaSlim7iAuraEditionCMGDN300x250 = function(mode,startPosition,loop,reversed) {
...
// library properties:
lib.properties = {
	id: '3EFCF47EFF0C46459E139E502420F353',
	width: 300,
	height: 250,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_Yoga_Slim_7i_Aura_Edition_CM_GDN_300x250_atlas_1.png", id:"PR_Yoga_Slim_7i_Aura_Edition_CM_GDN_300x250_atlas_1"}
	],
	preloads: []
};
...
an.compositions['3EFCF47EFF0C46459E139E502420F353'] = {
